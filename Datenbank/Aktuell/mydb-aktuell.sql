...
CREATE TABLE IF NOT EXISTS `persoenlichkeiten` (
...
CREATE TABLE IF NOT EXISTS `persoenlichkeiten_has_epochen` (
  `Persoenlichkeiten_Pers_ID` int(11) NOT NULL,
  `Epochen_E_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `persoenlichkeiten_has_kategorien` (
  `Persoenlichkeiten_Pers_ID` int(11) NOT NULL,
  `Kategorien_Kat_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `werke_has_persoenlichkeiten` (
