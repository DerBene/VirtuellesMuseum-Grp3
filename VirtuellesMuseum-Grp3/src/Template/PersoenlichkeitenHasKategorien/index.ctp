...
<div class="persoenlichkeitenHasKategorien index large-9 medium-8 columns content">
    <h3><?= __('Persoenlichkeiten Has Kategorien') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $persoenlichkeitenHasKategorien->Persoenlichkeiten_Pers_ID]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $persoenlichkeitenHasKategorien->Persoenlichkeiten_Pers_ID]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $persoenlichkeitenHasKategorien->Persoenlichkeiten_Pers_ID], ['confirm' => __('Are you sure you want to delete # {0}?', $persoenlichkeitenHasKategorien->Persoenlichkeiten_Pers_ID)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
