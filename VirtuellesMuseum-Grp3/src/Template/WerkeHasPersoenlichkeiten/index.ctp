...
<div class="werkeHasPersoenlichkeiten index large-9 medium-8 columns content">
    <h3><?= __('Werke Has Persoenlichkeiten') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $werkeHasPersoenlichkeiten->Werke_Werk_ID]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $werkeHasPersoenlichkeiten->Werke_Werk_ID]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $werkeHasPersoenlichkeiten->Werke_Werk_ID], ['confirm' => __('Are you sure you want to delete # {0}?', $werkeHasPersoenlichkeiten->Werke_Werk_ID)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
