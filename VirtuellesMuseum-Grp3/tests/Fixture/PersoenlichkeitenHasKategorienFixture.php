...
/**
 * PersoenlichkeitenHasKategorienFixture
 *
 */
class PersoenlichkeitenHasKategorienFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'persoenlichkeiten_has_kategorien';
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_Persönlichkeiten_has_Kategorien_Persönlichkeiten1_idx' => ['type' => 'index', 'columns' => ['Persoenlichkeiten_Pers_ID'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['Persoenlichkeiten_Pers_ID', 'Kategorien_Kat_ID'], 'length' => []],
            ...
            'fk_Persönlichkeiten_has_Kategorien_Persönlichkeiten1' => ['type' => 'foreign', 'columns' => ['Persoenlichkeiten_Pers_ID'], 'references' => ['persoenlichkeiten', 'Pers_ID'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
